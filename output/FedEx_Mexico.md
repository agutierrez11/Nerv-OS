...
[Error LLM: Error code: 429 - {'error': {'message': 'Rate limit reached for model `llama-3.3-70b-versatile` in organization `org_01knqhmgkbed29w8cpp8d77ft0` service tier `on_demand` on tokens per day (TPD): Limit 100000, Used 98328, Requested 1922. Please try again in 3m36s. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}]